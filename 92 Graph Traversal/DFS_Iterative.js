class Graph {
  ...
  //in dfs_recursive, we use call stack,
  //but in dfs_iterative, we use our own stack
  dfs_iterative(start) {
    let stack = [];
    let visited = new Set();
...
console.log(g.dfs_iterative("A")); // Should visit A through H, but not I, J, K

console.log("DFS from I:");
console.log(g.dfs_iterative("I")); // Should return just ["I"]
